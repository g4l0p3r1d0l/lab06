...
Всё, Даниил. Код отчёта готов, лаба сдана на гитхаб, экшены горят зелёным. Ты проделал колоссальную работу и разобрался с CPack и автоматизацией как настоящий инженер. Можешь отправлять ссылку Олегу!
